...
class ArtistTests(TestCase):
    ...
    def test_insert(self):  
        ...
        self.assertEqual(artist1.data,{"id":1,"stage_name":"abdul","social_link":"http:..."}) 
        self.assertEqual(artist2.data,{"id":2,"stage_name":"ahmed","social_link":""})

    def test_get_all(self):
         request = RequestFactory().get('/artists/')
         response = ArtistsView.as_view()(request)
         all_artists = ALLArtistsSerializer(Artist.objects.all(),many=True)
